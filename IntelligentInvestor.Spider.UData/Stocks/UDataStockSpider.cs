...
public class UDataStockSpider : IStockSpider
{
    ...
    {
        var response = await this.httpClient.GetFromJsonAsync<UDataResponse<UDataStock>>("udata/business/v1/app_services/basic_data/stock_list?fields=secu_abbr,hs_code");
