...
{
    Task<IEnumerable<Quote>> GetQuotesAsync(StockMarkets stockMarket, string stockCode, QuoteFrequencys quoteFrequency = QuoteFrequencys.NotSpecified, DateTime? fromTime = null, DateTime? toTime = null);
}
